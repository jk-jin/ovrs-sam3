...
class ModelOutputKeys:
    ...
    refined_encoder_features_18: str = "refined_encoder_features_18"
    refined_encoder_features_36: str = "refined_encoder_features_36"
    ...
    clip_score_embed_18: str = "clip_score_embed_18"
